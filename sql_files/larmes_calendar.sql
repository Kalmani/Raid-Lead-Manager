...
--
-- Structure de la table `larmes_calendar`
--

CREATE TABLE IF NOT EXISTS `larmes_calendar` (
  `evenement_id` int(11) NOT NULL AUTO_INCREMENT,
  `evenement_date` date NOT NULL,
  `eventement_fin` date NOT NULL,
  `evenement_comment` text COLLATE latin1_german2_ci NOT NULL,
