...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 23 Février 2015 à 12:34
...
--
-- Structure de la table `larmes_updates`
--

CREATE TABLE IF NOT EXISTS `larmes_updates` (
  `maj_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `maj_content` text CHARACTER SET latin1 COLLATE latin1_german2_ci NOT NULL,
  `maj_date` date NOT NULL,
  PRIMARY KEY (`maj_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=29 ;

--
-- Contenu de la table `larmes_updates`
--

INSERT INTO `larmes_updates` (`maj_id`, `user_id`, `maj_content`, `maj_date`) VALUES
